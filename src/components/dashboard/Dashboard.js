    ...
    <ThemeProvider theme={mdTheme}>
      ...
      >
        ...
        <Drawer variant="permanent" open={open}>
          ...
          >
            <img
              alt="mn"
              src={Logo}
              style={{ maxWidth: "93px", margin: "auto" }}
            />
            ...
            <div>
              <CTooltip content="Dashboard" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: over ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={overview}
                >
              ...
              <CTooltip content="Music Upload" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: oneRel ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={oneRelease}
                >
              ...
              <CTooltip content="MusicList" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: cat ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={musicList}
                >
              ...
              <CTooltip content="Analytics" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: analy ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={analytic}
                >
              ...
              <CTooltip content="Promotion" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: promo ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={promotion}
                >
              ...
              <CTooltip content="Financial" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: finance ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={financial}
                >
              ...
              <CTooltip content="Send Notification" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: neigh ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={neighbour}
                >
              ...
              <CTooltip content="Legal" placement="right">
                <ListItem
                  button
                  style={{
                    backgroundColor: leg ? "rgba(0, 0, 0, 0.04)" : null,
                    color: "#383a50",
                  }}
                  onClick={legal}
                >
        ...
        {over ? (
          ...
          <MusicList />
        ) : analy ? null : promo ? null : finance ? null : neigh ? null : leg ? null : null}
      </Box>
    </ThemeProvider>
  );
}
